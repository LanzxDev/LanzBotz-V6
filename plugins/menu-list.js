...
//  let tags
 //  let teks = `${args[0]}`.toLowerCase()
  ...
  const ftrol = {
      ...
      //------------------< MENU All>----------------
let all = `
Hello ${name}, ${ucapan()}, ꜱᴀʏᴀ ʙᴏᴛᴢ ᴡʜᴀᴛꜱᴀᴘᴘ ʏᴀɴɢ ʜᴀᴅɪʀ ᴅᴇɴɢᴀɴ ꜰɪᴛᴜʀ ᴋᴇʀᴇɴ ꜱᴇᴘᴇʀᴛɪ ᴅᴏᴡɴʟᴏᴀᴅ ᴛɪᴋᴛᴏᴋ, ʙᴜᴀᴛ ꜱᴛɪᴋᴇʀ, ᴄᴀʀɪ ʟᴀɢᴜ, ᴅᴀɴ ᴍᴀꜱɪʜ ʙᴀɴʏᴀᴋ ʟᴀɢɪ.  ꜰɪᴛᴜʀ ʏᴀɴɢ ᴛᴇʀꜱᴇᴅɪᴀ ᴀᴅᴀ ᴅɪ ʙᴀᴡᴀʜ ɪɴɪ

 *Databases* : ${totalreg}
 *Baileys:* Multi Device
 
ᴊɪᴋᴀ ᴍᴇɴᴇᴍᴜᴋᴀɴ ᴇʀʀᴏʀ, ʜᴀʀᴀᴘ ꜱᴇɢᴇʀᴀ ʟᴀᴘᴏʀᴋᴀɴ ᴅᴇɴɢᴀɴ ᴍᴇɴɢᴇᴛɪᴋ .ʟᴀᴘᴏʀᴀɴ ꜱᴇʟᴀᴍᴀᴛ ꜱᴏʀᴇ ᴘᴇᴍɪʟɪᴋ ꜰɪᴛᴜʀ ᴅᴏᴡɴʟᴏᴀᴅ-ɪɢ ᴇʀʀᴏʀ!  ᴍᴇᴍᴘᴇʀʙᴀɪᴋɪɴʏᴀ!
